#!/usr/bin/env python3
# ponytail: runtime draft inspector for paper-critic skill.
...
def main():
    ...
    if want:
        ...
        # default: harvest abstract + intro + experiments + any ablation block
        ...
        # an ablation block: search subsection headings
        abl_idx = None
        for i, s in enumerate(sections):
    ...
    print("\n## Structural completeness (vs CVPR expectations)")
