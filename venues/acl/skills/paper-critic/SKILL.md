...
name: paper-critic
description: >
  ACL paper critic that thinks like a senior advisor / reviewer. Reviews a LaTeX draft
  ...
  domain-neutral critique checklist plus compact ACL 2026 expectations (corpus medians
  from 267 accepted oral papers). Use when the user says "critique my paper", "review my
  ...
  for style/structure measurement — use `paper-style` for that. Lives at venues/acl;
  ACL-only this iteration.
---
...
6. **Prioritize findings** by what an ACL reviewer would weight most:
